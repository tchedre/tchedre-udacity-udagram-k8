...
1. Go to your udacity-c3-deployment/k8s/terraform folder
...
5. Install Kubernetes using configuration output from Terraform: `kubeone apply --manifest kubeone.yaml -t tf.json`
...
- Travis CI is setup to monitor for updates to main branch